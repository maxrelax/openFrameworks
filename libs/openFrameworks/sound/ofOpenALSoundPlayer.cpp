...
//------------------------------------------------------------
bool ofOpenALSoundPlayer::decoderReadFile(string path,vector<short> & buffer,vector<float> & fftAuxBuffer){
...
// ----------------------------------------------------------------------------
vector<float>& ofOpenALSoundPlayer::getSpectrum(int bands){
    initFFT(bands);
...
int ofOpenALSoundPlayer::freqToIndex(float freq) {
...
// ----------------------------------------------------------------------------
void ofOpenALSoundPlayer::setLogAverages(int minBandwidth, int bandsPerOctave){
    if(!isLoaded()){
        return;
    }
...
// ----------------------------------------------------------------------------
int ofOpenALSoundPlayer::getMinBandwidth(){
    return currentMinBandwidth;
}

// ----------------------------------------------------------------------------
int ofOpenALSoundPlayer::getBandsPerOctave(){
...
// ----------------------------------------------------------------------------
bool ofOpenALSoundPlayer::checkErrors(string description){
    ALenum err = alGetError();
    if (err != AL_NO_ERROR){
        ofLogError() << "ofOpenALSoundPlayer: error " << alGetString(err) << " " << description;
        return false;
    }
    return true;
}